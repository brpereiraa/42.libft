...
SRCS = ft_atoi.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_itoa.c ft_memcmp.c \
		...
		ft_strcpy.c ft_strdup.c ft_strjoin.c ft_strlen.c ft_strncmp.c ft_strncpy.c ft_strnstr.c ft_substr.c ft_lstiter.c \
		...
		ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c ft_lstdelone.c ft_strrchr.c ft_strlcpy.c ft_strmapi.c ft_striteri.c ft_lstmap.c
